...
export const useMetaTags = (defaultMeta) => {
  ...
  const metaData = {
    ...
    "/blog/multi-agent-ai-as-your-performance-partner": {
      title: "Multi-Agent AI: Your Performance Partner for Marketing",
      description:
        "See how multi-agent AI serves as a performance partner to plan, analyze, create, and execute within brand guidelines. Explore Climaty AI’s Agentic ecosystem.",
    },
